        ...
        while play_again: #check the condition for playong game again
            try: #check if user input number for board size
                ...
                if size >= 4: #the board size should more than 4
                    x = Board(size)
                    name_player = [] #list store player name
                    id_player = [] #list store id player
                    ...
                    try: #check the use input the number for ID player.
                        ...
                        p1 = Player1(name_player1, id_player1,size)
                        name_player2 = input("Hi! Player2. Please enter you name: ")
                        ...
                        while True: #check  if user input the repeating name and ID 
                            ...
                            p2 = Player2(name_player2, id_player2,size)
                            ...
                            while play: #ask two to enter the two player movement
                                p1.move_player1()
                                play=x.check_game() #checking the condition for while loop
                                ...
                                if play == False: #if game over, the loop for entering movement will break out.
                                    break
                                x.size_board() #printing the board, if the game continue
                
                            x.size_board() #if the loop for playing is over, it will printing the board

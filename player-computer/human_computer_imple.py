...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 16 21:35:00 2021

@author: gracepichar
"""

from Part1_human_computer import Board, Player1, Humanplayer, Computerplayer
            ...
            try: #check if user input number for board size
                ...
                if size >= 4: #the board size should more than 4
                    ...
                    try: #check the use input the number for ID player.
                        ...
                        name_player2 = input("Hi!, please give the name of Computer Player: ")
                        ...
                        while True: #check  if user input the repeating name and ID 
                            ...
                            p2 = Computerplayer("","",name_player2, id_player2,size)
                            ...
                            play = x.check_game()
                            print("Let's start!")
                            while play: # check the first movement of compuerplayer(P2) aren't out of the board
                                p1.move_player1()
                                p1.size_board()
                                play=x.check_game()#check the player1 doesn't go out of the grid board
                                if play == False: #if game over, the loop for entering movement will break out.
                                    break
                                p2.get_move() #random movement for computer player
                                p2.check_firtsstep() #check the first step should not be D and R
                                p2.move_player2()
                                p2.size_board()

...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  6 12:20:43 2021
...
if answer == "yes": #if they say yes, we will play this game
    ...
    print("6. The game will be over, if one player crashes into the wall or move the wrong direction.")
    print("----------------------------------------------------------------------------")
    print("Have fun!")
            ...
            try: #check if user input number for board size
                ...
                if size >= 4: #the board size should more than 4
                    ...
                    try: #check the use input the number for ID player.
                        ...
                        name_player.append(name_player1)
                        id_player.append(id_player1)
